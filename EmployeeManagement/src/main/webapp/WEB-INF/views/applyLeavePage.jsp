               ...
               <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <input type="date" name="txtEmail" class="form-control" placeholder="from date" value="" />
                        </div>
                         <div class="form-group">
                            <input type="date" name="txtEmail" class="form-control" placeholder="to date" value="" />
                        </div>
                        <div class="form-group">
